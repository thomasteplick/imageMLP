...
const (
	...
	patternTrainingMLP = "/imageMLP"                  // http handler for training the MLP
	patternTestingMLP  = "/imageMLPtest"              // http handler for testing the MLP
...
func (mlp *MLP) drawImages(r *http.Request) error {
